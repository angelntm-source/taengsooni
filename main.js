...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Inquiry Form Submission (Formspree)
    ...
    modalTriggers.forEach(trigger => {
        ...
        if (link && modal) {
            ...
            console.warn(`Missing modal elements for: ${trigger.linkId} or ${trigger.modalId}`);
        }
    });

    console.log('TAENG SOO NI - Logic Bindings Completed');
});
